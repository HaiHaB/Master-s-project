...
/**
Get all information including AtomNumber, moleculeNo, nameList and float data from a file
 **/
...
info getFileData(string fileName) {
	...
	//printf("got %s containing %d molecules of %d atoms \n", fileName.c_str(), moleculeNo, atomNo);
